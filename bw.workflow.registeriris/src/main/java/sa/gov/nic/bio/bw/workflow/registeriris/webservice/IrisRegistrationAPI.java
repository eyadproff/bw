...
import sa.gov.nic.bio.bw.workflow.registeriris.beans.IrisRegistrationResponse;

public interface IrisRegistrationAPI
{
	@FormUrlEncoded
	@POST("services-gateway-biooperation/api/iris/registration/v1")
	Call<IrisRegistrationResponse> submitIrisRegistration(@Header("Workflow-Code") Integer workflowId,
