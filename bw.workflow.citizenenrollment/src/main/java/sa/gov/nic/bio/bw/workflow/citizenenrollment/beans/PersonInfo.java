...
public class PersonInfo extends JavaBean {
    ...
    public String getBirthHijGregInd() {
        return birthHijGregInd;
    }

    public void setBirthHijGregInd(String birthHijGregInd) {
        this.birthHijGregInd = birthHijGregInd;
    }
    ...
    public PersonIdInfo getIdentityInfo() {
        return identityInfo;
    }

    public void setIdentityInfo(PersonIdInfo identityInfo) {
    ...
    public List<WantedInfo> getWantedInfos() {
        return wantedInfos;
    }

    public void setWantedInfos(List<WantedInfo> wantedInfos) {
        this.wantedInfos = wantedInfos;
    }
