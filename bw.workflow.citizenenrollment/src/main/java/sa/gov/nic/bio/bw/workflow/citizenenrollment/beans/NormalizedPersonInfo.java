...
public class NormalizedPersonInfo extends JavaBean {
    ...
    public NormalizedPersonInfo(PersonInfo personInfo) {
        ...
        if (facePhotoBase64 != null && facePhotoBase64.strip().isBlank()) {
        ...
        if (name != null) {
            ...
            grandfatherName = AppUtils
                    .buildNamePart(name.getGrandfatherName(), name.getTranslatedGrandFatherName(), false);
            ...
            grandfatherNameLabel = AppUtils
                    .buildNamePart(name.getGrandfatherName(), name.getTranslatedGrandFatherName(), true);
        ...
        if (genderInt != null && (genderInt == 1 || genderInt == 2)) {
            gender = Gender.values()[genderInt - 1];
        }
        ...
        if (nationalityInteger != null) {
            ...
            String unknownNationalityText = AppUtils.getCoreStringsResourceBundle()
                    .getString("combobox.unknownNationality");
            Country unknownNationality = new Country(0, null, unknownNationalityText, unknownNationalityText);
        ...
        if (occupation != null && occupation.strip().isBlank()) {
            occupation = null;
        }
        birthPlace = personInfo.getBirthPlace();
        if (birthPlace != null && birthPlace.strip().isBlank()) {
            birthPlace = null;
        }
        ...
        @SuppressWarnings("unchecked")
        List<DocumentType> documentTypes = (List<DocumentType>) Context.getUserSession()
                .getAttribute(DocumentTypesLookup.KEY);
    ...
    public LocalDate getDocumentIssuanceDate() {
    ...
    public String getFatherNameLabel() {
        return fatherNameLabel;
    }

    public void setFatherNameLabel(String fatherNameLabel) {
    ...
    public String getGrandfatherNameLabel() {
        return grandfatherNameLabel;
    }

    public void setGrandfatherNameLabel(String grandfatherNameLabel) {
        this.grandfatherNameLabel = grandfatherNameLabel;
    }
    ...
    public void setFamilyNameLabel(String familyNameLabel) {
        this.familyNameLabel = familyNameLabel;
    }
