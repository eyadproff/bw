...
public class ForeignInfo
{
	...
	public ForeignInfo(Long candidateId, String firstName, String secondName, String otherName, String familyName,
	...
	public boolean equals(Object o)
	{
		...
		ForeignInfo that = (ForeignInfo) o;
	...
	{
		return "ForeignInfo{" + "candidateId=" + candidateId + ", firstName='" + firstName + '\'' + ", secondName='" +
