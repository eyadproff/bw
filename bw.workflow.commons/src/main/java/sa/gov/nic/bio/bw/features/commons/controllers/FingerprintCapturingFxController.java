...
import sa.gov.nic.bio.bw.features.commons.beans.FingerprintUiComponents;
import sa.gov.nic.bio.bw.features.commons.ui.AutoScalingStackPane;
import sa.gov.nic.bio.bw.features.commons.ui.FourStateTitledPane;
...
import sa.gov.nic.bio.bw.features.commons.webservice.FingerCoordinate;
...
public class FingerprintCapturingFxController extends WizardStepFxControllerBase
{
	...
	private void attachSlapFingerprintsLegendTooltip(Node targetNode)
	{
		...
		vBox.getStylesheets().setAll("/sa/gov/nic/bio/bw/features/commons/css/style.css");
