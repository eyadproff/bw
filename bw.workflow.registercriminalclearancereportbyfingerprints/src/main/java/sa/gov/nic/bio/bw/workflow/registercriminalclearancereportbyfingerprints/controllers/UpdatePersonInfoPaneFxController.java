package sa.gov.nic.bio.bw.workflow.registercriminalclearancereportbyfingerprints.controllers;
...
public class UpdatePersonInfoPaneFxController extends WizardStepFxControllerBase {
    ...
    protected void onAttachedToScene() {
        ...
        BooleanBinding txtGrandFatherNameBinding = GuiUtils.textFieldBlankBinding(txtGrandfatherName);

        btnNext.disableProperty().bind(txtFirstNameBinding.or(txtFatherNameBinding).or(txtFamilyNameBinding).or(txtGrandFatherNameBinding));
