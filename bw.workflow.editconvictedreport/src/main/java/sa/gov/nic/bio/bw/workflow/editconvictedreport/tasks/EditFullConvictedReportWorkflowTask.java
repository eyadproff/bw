...
public class EditFullConvictedReportWorkflowTask extends WorkflowTask
{
	...
	public void execute() throws Signal
	{
		...
		Call<Long> apiCall = api.editFullConvictedReport(workflowId, workflowTcn, convictedReportJson);
