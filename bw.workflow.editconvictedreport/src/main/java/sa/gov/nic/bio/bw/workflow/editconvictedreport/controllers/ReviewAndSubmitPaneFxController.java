...
public class ReviewAndSubmitPaneFxController extends WizardStepFxControllerBase
{
	...
	protected void onAttachedToScene()
	{
		...
		if(fingerprintBase64Images != null) GuiUtils.attachFingerprintImages(fingerprintBase64Images,
		                                                                     null, ivRightThumb,
		...
		GuiUtils.setLabelText(lblBirthDate, true, birthDateNewValue);
		...
		GuiUtils.setLabelText(lblDocumentIssuanceDate,true, documentIssuanceDateNewValue);
		GuiUtils.setLabelText(lblDocumentExpiryDate,true, documentExpiryDateNewValue);
		...
		GuiUtils.setLabelText(lblJudgmentDate, true, judgmentDateNewValue);
		...
		GuiUtils.setLabelText(lblArrestDate,true, arrestDateNewValue);
		...
		GuiUtils.setLabelText(lblBirthDateOldValue,true, birthDateOldValue);
		...
		GuiUtils.setLabelText(lblDocumentIssuanceDateOldValue,true, documentIssuanceDateOldValue);
		GuiUtils.setLabelText(lblDocumentExpiryDateOldValue,true, documentExpiryDateOldValue);
		...
		GuiUtils.setLabelText(lblJudgmentDateOldValue,true, judgmentDateOldValue);
		...
		GuiUtils.setLabelText(lblArrestDateOldValue, true, arrestDateOldValue);
