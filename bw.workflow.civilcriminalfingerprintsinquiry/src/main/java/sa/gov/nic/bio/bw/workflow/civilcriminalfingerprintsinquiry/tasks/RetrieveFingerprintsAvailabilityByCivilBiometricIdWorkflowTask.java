...
public class RetrieveFingerprintsAvailabilityByCivilBiometricIdWorkflowTask extends WorkflowTask
{
	...
	public void execute() throws Signal
	{
		...
		Call<List<Integer>> call = api.getFingerprintsAvailabilityByCivilBiometricsId(workflowId, workflowTcn,
		                                                                              civilBiometricsId);
