...
public class InquiryByFingerprintsPaneFxController extends WizardStepFxControllerBase
{
	...
	@FXML private Button btnShowFingerPrints;
	@FXML private Button btnReCaptureFingerPrints;
	...
	public void onReturnFromWorkflow(boolean successfulResponse)
	{
		if(successfulResponse)
		{
			...
			else if (status.equals(Status.NOT_HIT)) {
				hitProgress(false);
			}
		}
	...
	private void hitProgress(boolean bShow)
	{
		GuiUtils.showNode(piProgress, false);
		GuiUtils.showNode(lblProgress, false);
		GuiUtils.showNode(btnCancel, false);
		...
		GuiUtils.showNode(btnRetry, !bShow);
		GuiUtils.showNode(btnShowFingerPrints, bShow);
		GuiUtils.showNode(btnReCaptureFingerPrints, true);
	}
	...
	@FXML
	private void onShowingFingerPrints(ActionEvent actionEvent)
	{

	}

	@FXML
	private void onReCapturingFingerPrints(ActionEvent actionEvent)
	{
